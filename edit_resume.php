 ...
 include 'session.php';
    ...
    { 
		...
		$mobile=mysqli_real_escape_string($connection, $_POST['mobile']);
            ...
            $sql="UPDATE resumes
            SET name='$username', varsityname = '$varsityname', year= '$year', address='$address',mobile='$mobile'
      ...
      <div class="row">
        ...
        <form action="edit_resume.php" method="POST">
           ...
           <div class="form-group">
                <label>Name</label>
                <input type="text" name="username" class="form-control" id="name" placeholder="Example:Abdullah">
            </div>
            <div class="form-group">
